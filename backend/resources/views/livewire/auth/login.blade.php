                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    @endif
                                    <form class="mt-4 pt-2" wire:submit.prevent="doLogin">
                                        <div class="mb-3">
                                            <label class="form-label">Username</label>
                                            <input type="text" class="form-control" id="username" placeholder="Enter username" wire:model.defer="email">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group auth-pass-inputgroup">
                                                <input type="password" class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon" wire:model.defer="password">
